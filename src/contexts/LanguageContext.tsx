...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'cancer.kidney.desc': 'سرطان الخلايا الكلوية (RCC)',
    'cancer.wilms': 'ورم ويلمز (Wilms Tumor)',
    'cancer.wilms.desc': 'للأطفال - بروتوكول SIOP 2016',
    ...
    'postop.pt1': 'pT1 - محصور في الكلى وخالٍ من الانفجار',
    'postop.pt2': 'pT2 - امتداد وراء الكلية مستأصل بالكامل',
    'postop.pt3': 'pT3 - استئصال غير كامل أو انفجار أو عقد إيجابية',
    'postop.pt1a': 'pT1a - ورم ≤4 سم',
    'postop.pt1b': 'pT1b - ورم >4 سم و ≤7 سم',
    'postop.pt2a': 'pT2a - ورم >7 سم و ≤10 سم',
    'postop.pt2b': 'pT2b - ورم >10 سم',
    'postop.pt3a': 'pT3a - امتداد للوريد الكلوي/الدهون حول الكلى',
    'postop.pt3b': 'pT3b - الوريد الأجوف تحت الحجاب',
    'postop.pt3c': 'pT3c - الوريد الأجوف فوق الحجاب',
    'postop.pt4': 'pT4 - ما بعد لفافة جيروتا',
    'postop.pnx': 'pNX - لم يتم فحص العقد',
    'postop.pn0': 'pN0 - لا توجد عقد إيجابية',
    'postop.pn1': 'pN1 - توجد عقد إيجابية',
    'postop.pmx': 'pMX - لا يمكن تقييم النقائل',
    'postop.pm0': 'pM0 - لا توجد نقائل بعيدة',
  ...
  en: {
    ...
    'cancer.kidney.desc': 'Renal Cell Carcinoma (RCC)',
    'cancer.wilms': 'Wilms Tumor (Nephroblastoma)',
    'cancer.wilms.desc': 'Pediatric - SIOP-RTSG 2016',
    ...
    'postop.pt1': 'pT1 - Limited to kidney and rupture-free',
    'postop.pt2': 'pT2 - Extra-renal extension completely excised',
    'postop.pt3': 'pT3 - Incomplete excision, rupture, or nodes+',
